...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Rectangle r1= new Rectangle(10,5, 20, 20);
        Rectangle r2= new Rectangle();

        Square s1 = new Square(4,90, 90);
        Square s2 = new Square(3,10, 90);
        ...
        while (true) {
            ...
            r1.draw(StdDraw.CYAN, StdDraw.BLUE);
            r2.draw();

            s1.draw(StdDraw.YELLOW, StdDraw.GREEN);
            s2.draw();
