...
public class Main {
    public static void main(String[] args){
        BouncingRectangle[] bouncingRectangles = new BouncingRectangle[10];

        for(int i=0; i<bouncingRectangles.length; i++){
            BouncingRectangle bouncingRectangle = new BouncingRectangle(Math.random()*60+20,  Math.random()*60+20, 5, 5, 100 );
            bouncingRectangles[i] = bouncingRectangle;
        }
        ...
        while (true) {
            ...
            */
            for(int i=0; i<bouncingRectangles.length; i++){
                bouncingRectangles[i].calculate(timeElapsed, totalTimeElapsed);
            }
